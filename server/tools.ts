...
import { createKanbanTool } from "../modules/kanban/server/tool";
import { createCrmTool } from "../modules/crm/server/tool";
import { kanbanDb, crmDb } from "./db-persist";

const kanbanTool: NamiTool = createKanbanTool(kanbanDb, logAudit) as NamiTool;
const crmTool: NamiTool = createCrmTool(crmDb, logAudit, () => _engine?.runContactIntelligenceAnalysis) as NamiTool;
