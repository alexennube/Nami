...
- **Tools:** A comprehensive tool registry (`file_read`, `file_write`, `file_edit`, `file_search`, `shell_exec`, `web_browse`, `web_search`, `google_workspace`, `ennube_mcp`, `create_swarm`, `manage_swarm`, `server_restart`, `self_inspect`, `docs_read/write`, `x_post_tweet`, `x_delete_tweet`, `browser_control`, `kanban`, `crm`) with a permission layer and function calling integration for LLMs.
